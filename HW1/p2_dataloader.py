...
class ImageMaskDataset(Dataset):
    ...
    def count_class_occurrences(self):
        ...
        for idx in range(len(self)):
            if self.Train:
                ...
                mask[raw_mask == 3] = 0  # Urban land
                mask[raw_mask == 6] = 1  # Agriculture land
                mask[raw_mask == 5] = 2  # Rangeland
                mask[raw_mask == 2] = 3  # Forest land
                mask[raw_mask == 1] = 4  # Water
                mask[raw_mask == 7] = 5  # Barren land
                mask[raw_mask == 0] = 6  # Unknown
...
if __name__ == '__main__':
    ...
    dataset = ImageMaskDataset('hw1_data/p2_data/validation',
                     transform=transforms.ToTensor(), train=True, augmentation=True)

    print(dataset.count_class_occurrences())
    print(len(dataset))
